...
class NPOSTrainer:
    def __init__(self, net: nn.Module, train_loader: DataLoader,
        ...
        self.net, self.optimizer = amp.initialize(self.net, self.optimizer, opt_level='O2')
    ...
    def train_epoch(self, epoch_idx):
        ...
        for train_step in tqdm(range(1,
            ...
            # forward
            penultimate = self.net.backbone(data.half())
            ...
            if sum_temp == self.n_cls * self.sample_number \
                ...
                # print('gh debug:{}'.format(ood_samples[0].shape))
...
class CompLoss(nn.Module):
    ...
    def forward(self, features, prototypes, labels):
        ...
        # compute logits
        anchor_feature = features.half()
        contrast_feature = prototypes.half() / prototypes.norm(dim=-1, keepdim=True).half()
