...
class OODEvaluator(BaseEvaluator):
    ...
    def eval_ood(self,
        ...
        id_pred, id_conf, id_gt = postprocessor.inference(
            net, id_data_loaders['test'])
        # ipdb.set_trace()
        # np.save('/home1/gaoheng/gh_workspace/OAML/viz/vim/imagenet1k-224x224/id_feat_' +  dataset_name + '.npy', id_feat)
    ...
    def _eval_ood(self,
        ...
        for dataset_name, ood_dl in ood_data_loaders[ood_split].items():
            ...
            # ood_feat_array = np.array(ood_feat)
            # np.save('/home1/gaoheng/gh_workspace/OAML/viz/vim/imagenet1k-224x224/ood_feat_' +  dataset_name + '.npy', ood_feat_array)
            # print("GH debug, the shape of ood feat:{}".format(ood_feat.shape))  # (9000, 512)
            # ipdb.set_trace()
            
            # ood_conf_array = np.array(ood_conf)
            # np.save('/home1/gaoheng/gh_workspace/OAML/viz/ebo/cifar10/oe_ood_conf_' +  dataset_name + '.npy', ood_conf_array)
            # ipdb.set_trace()
