...
parser.add_argument('--K_in_knn', type=int, default=500)
parser.add_argument('--ood_det_select', type=int, default=50)
parser.add_argument('--ood_gene_select', type=int, default=50)
...
num_classes = 100
sum_temp = 0
data_dict = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/outlier-generation/id_feat_cifar100_199epoch.npy')).cuda()
