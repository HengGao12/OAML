...
args.save = '/home1/gaoheng/gh_workspace/dream-ood-main/scripts/snapshots/text_condition_c100'
...
train_data_in = dset.CIFAR100('/home1/gaoheng/gh_workspace/dream-ood-main/data/dataset/my_xfdu/cifarpy', train=True, transform=train_transform, download=True)
test_data = dset.CIFAR100('/home1/gaoheng/gh_workspace/dream-ood-main/data/dataset/my_xfdu/cifarpy', train=False, transform=test_transform, download=True)
if args.add_class:
    num_classes = 101
else:
    num_classes = 100
...
anchor = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/dream-ood-main/token_embed_c100.npy')).cuda()
