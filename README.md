...
To address these problems, knowledge distillation is leveraged to prevent ID accuracy decreasing. On the other hand, we generate and train OOD samples in the latent space for enlarging the ID/OOD distribution discrepancies.
