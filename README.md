...
To address these problems, knowledge Distillation is leveraged to prevent ID accuracy degradation. On the other hand, we generate and train OOD samples in the latent space for enlarging the ID/OOD distribution discrepancies.
