...
To address these problems, we introduce knowledge distillation techniques to prevent ID accuracy decreasing, which is also proved to have beneficial for OOD detection quality. On the other hand, we generate and train OOD samples in the latent space to further enlarge ID/OOD feature discrepancies.  
...
| :---------: | :--------------------------------------: |
|  CIFAR-10   | [OneDrive](https://1drv.ms/f/s!AlJaja8mSaMgeRL8EB3OjNC_SS4?e=E0152U) |
