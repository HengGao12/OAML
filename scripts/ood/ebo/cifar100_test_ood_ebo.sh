...
python main.py \
    ...
    --network.checkpoint 'results/cifar100_resnet18_224x224_base_distill_trainer_e500_lr0.01_default_w_fea_n_logits_distill_dev4_2kl_4fd/s0/best_epoch361_acc0.8090.ckpt' --merge_option merge
...
# ld: /home1/gaoheng/gh_workspace/GOLDEN_HOOP/results/cifar100_resnet18_224x224_distill_trainer_e100_lr0.01_default_w_logits_dist/s0/best_epoch93_acc0.7940.ckpt
