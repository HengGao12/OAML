...
python main.py \
    ...
    --num_workers 8 \
    --network.checkpoint '/home1/gaoheng/gh_workspace/GOLDEN_HOOP/results/cifar100_oe_resnet18_224x224_oe_e100_lr0.1_lam0.5_default/s0/best.ckpt' \
    --mark 0 --merge_option merge

# /public/home/gaoheng/gh_workspace/GOLDEN_HOOP/results/
