...
anchor = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/GOLDEN_HOOP/data/outlier_data/token_embed_in1k.npy')).cuda()
num_classes = 1000
sum_temp = 0
# ood_samples = []

data_dict = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/GOLDEN_HOOP/id_feat_in1k.npy')).cuda()
# ipdb.set_trace()
