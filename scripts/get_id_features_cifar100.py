...
config_files = [
    './configs/datasets/cifar100/cifar100_224x224.yml',
...
net.cuda()
net.load_state_dict(
    torch.load('/home1/gaoheng/gh_workspace/OAML/results/cifar100_resnet18_224x224_base_e100_lr0.1_default/s0/best.ckpt')
)
...
np.save('/home1/gaoheng/gh_workspace/OAML/id_feat_cifar100_res18.npy', data_dict.cpu().numpy())