...
anchor = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/GOLDEN_HOOP/data/outlier_data/token_embed_c10.npy')).cuda() # (10, 768)

num_classes = 10
sum_temp = 0
data_dict = torch.from_numpy(np.load('/home1/gaoheng/gh_workspace/GOLDEN_HOOP/id_feat_cifar10_199epoch.npy')).cuda()  # (10, 500, 768)
# ipdb.set_trace()
